...
public class StringOperation {
    public static void main(String[] args) {
        ...
        /**
         * String分配：直接量是直接存常量池的地址，不会在堆上创建新的对象，所以两个内容相同的直接量==相等，
         * 两个内容相同的new出来的String不能==
         */
...
//        System.out.println("".indexOf(''));           // 编译报错，char不能是空
        ...
        /**
         * string 转 数字类型
         * Type包装类型.parseInt("")返回值是type的基本数据类型
         * Type包装类型.valueOf("")返回值是type的包装类型
         */
...
//        System.out.println(l1); // 123.5 浮点字符串不能转换成数字型，会报错
//        System.out.println(l2); // 会报错
         ...
         * StringBuilder修改缓冲区的方法是同步的，所以是线程安全的
